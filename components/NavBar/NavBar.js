                    ...
                    <ul className="flex items-center hidden space-x-8 lg:flex">
                        ...
                        <li>
                            ...
                            {user?.uid ?
                                ...
                                <img className='w-12 h-12 rounded-full' src="https://img.freepik.com/free-icon/woman_318-157570.jpg?size=338&ext=jpg&ga=GA1.2.821203553.1657130385&semt=ais" title={user?.displayName} alt='user' />
                                :
                                <img className='w-12 h-12 rounded-full' src="https://img.freepik.com/free-icon/user-black-close-up-shape_318-48677.jpg?size=338&ext=jpg&ga=GA1.2.821203553.1657130385&semt=ais" title='Guest' alt='user' />
